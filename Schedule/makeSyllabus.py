...
FIRSTDAY = datetime.date(2020, 9, 7)
Ds = [datetime.timedelta(1), datetime.timedelta(1), datetime.timedelta(2), datetime.timedelta(3)] #Monday To Tuesday, Tuesday to Wednesday, Wednesday to Friday, Friday to Monday
Holidays = {datetime.date(2020, 11, 27):"Thanksgiving"}
